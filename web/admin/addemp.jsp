...
<table border="0" width="950" height="350" bgcolor="#ffffff"
    ...
    <tr>
        <td align="center" valign="top">
            <form name="form1" method="post" id="empform">
                <table width="500" border="0" cellpadding="5" cellspacing="1"
                    ...
                    <tr>
                        ...
                        <td height="24" bgcolor="#FFFFFF">
                            <input name="phoneNumber" type="text" id="phone_number">
                    ...
                    <tr>
                        ...
                        <td height="24" bgcolor="#FFFFFF">
                            <input name="hireDate" type="text" id="hire_date"  onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',minDate:'%y-%M-%d'})">
                    ...
                    <tr>
                        ...
                        <td height="24" bgcolor="#FFFFFF">
                            ...
                            <select name="jobId" id="jobId" onchange="showSal()">

                                 <option>请选择职务</option>
                                <c:forEach items="${job}" var="jo">
                                <option value="${jo.jobId}">${jo.jobTitle}</option>
                                </c:forEach>
                            </select>
                            ...
                            ~
                            <input name="max_salary" type="text" id="max_salary" size="10" readonly>
                        </td>
                    </tr>
                    <tr>
                        <td height="24" bgcolor="#FFFFFF">
                    ...
                    <tr>
                        <td height="24" colspan="2" align="center" bgcolor="#FFFFFF">
                            <input type="button" addemployee onclick="addemployee()" value="提交">
